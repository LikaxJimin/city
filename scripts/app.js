...
button.addEventListener('click', function(){
   let imageObject = document.querySelector('.cover-image img');
    let gallery = ['assets/cover.jpg','assets/cover-1.jpg','assets/cover-2.jpg','assets/cover-3.jpg','assets/cover-4.jpg','assets/cover-5.jpg']
...
weather.open('GET', 'https://goweather.herokuapp.com/weather/Curitiba', true)
